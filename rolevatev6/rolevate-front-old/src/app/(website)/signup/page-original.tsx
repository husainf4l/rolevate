...
//             <div className="absolute inset-0 bg-gradient-to-tr from-[#13ead9]/10 via-white/20 to-[#0891b2]/10 rounded-sm shadow-2xl backdrop-blur-sm border border-white/30 group-hover:shadow-3xl transition-all duration-500"></div>
//             <div className="absolute inset-4 rounded-sm overflow-hidden shadow-inner ring-1 ring-white/20">
//               <Image
//                 src="/images/hero.png"
