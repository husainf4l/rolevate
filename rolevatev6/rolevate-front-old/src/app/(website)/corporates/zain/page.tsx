...
//     logo: "📱",
//     description:
//       "Lead the development of cutting-edge web applications for Zain's digital transformation.",
//     urgent: true,
//   },
//   {
//     id: 3,
...
//     logo: "📱",
//     description:
//       "Build next-generation mobile applications for millions of Zain customers across Jordan.",
//     urgent: false,
//   },
//   {
//     id: 4,
...
//     logo: "📱",
//     description:
//       "Scale and optimize infrastructure for Zain's digital services and telecommunications platform.",
//     urgent: true,
//   },
//   {
//     id: 5,
...
//     logo: "📱",
//     description:
//       "Analyze customer data and network performance to drive strategic business decisions.",
//     urgent: false,
//   },
//   {
//     id: 6,
...
//     logo: "📱",
//     description:
//       "Drive product innovation and strategy for Zain's telecommunications and digital services.",
//     urgent: false,
//   },
// ];
...
//   description:
//     "Zain Jordan is a leading telecommunications company in Jordan, providing innovative mobile, internet, and digital services to millions of customers. As part of the Zain Group, we're committed to enriching lives and empowering communities through cutting-edge technology and exceptional customer service.",
//   mission:
//     "To be the leading digital lifestyle provider in Jordan, enriching the lives of our customers through innovative telecommunications and digital services.",
//   values: [
//     "Customer First",
...
//                 <Button variant="primary" size="xl" href="#jobs">
...
//                   <div className="text-8xl lg:text-9xl">{companyData.logo}</div>
//                 </div>
...
//       <section
//         id="jobs"
//         className="w-full pt-8 pb-24 md:pt-12 md:pb-32 bg-white"
//       >
//         <div className="container mx-auto px-6 md:px-12">
//           {/* Jobs Header */}
//           <div className="text-center mb-16">
...
//               Join our team and help shape the future of telecommunications in
//               Jordan.
//               {sortedJobs.length} opportunities are waiting for talented
