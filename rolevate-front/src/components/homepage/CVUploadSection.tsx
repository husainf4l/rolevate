        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            <div className="text-center">
              ...
              <h3 className="font-display text-xl md:text-2xl font-bold text-gray-900 mb-4">Perfect Job Matching</h3>
              <p className="font-text text-gray-600 leading-relaxed">Our AI analyzes your skills, experience, and preferences to match you with the most suitable job opportunities in Jordan, Qatar, and KSA.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-display text-xl md:text-2xl font-bold text-gray-900 mb-4">Comprehensive CV Analysis</h3>
              <p className="font-text text-gray-600 leading-relaxed">Get detailed insights on your CV including strengths, areas for improvement, keyword optimization, and formatting suggestions.</p>
            </div>
            ...
            <div className="text-center md:col-span-2 lg:col-span-1">
              ...
              <h3 className="font-display text-xl md:text-2xl font-bold text-gray-900 mb-4">Career Enhancement</h3>
              <p className="font-text text-gray-600 leading-relaxed">Receive personalized recommendations for skill development, certifications, and career progression paths tailored to the Middle East job market.</p>
            </div>
          </div>
        </div>
      </div>
