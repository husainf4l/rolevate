  ...
  return (
    <div className="p-8 lg:p-12 space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900 tracking-tight">AI Recruitment Configuration</h2>
          <p className="text-gray-600 text-sm mt-1">Configure AI prompts for automated CV analysis and interview stages</p>
        </div>
      </div>
      ...
      <div className="space-y-8">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-sm">
              Configure how AI will analyze CVs and conduct interviews for this position. These prompts will guide the AI through each stage of your recruitment process, ensuring consistent and effective candidate evaluation.
            </p>
            {isGenerating && (
              <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center gap-2">
                ...
                <span className="text-sm text-blue-700 font-medium">Generating AI prompts based on your job details...</span>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <label htmlFor="aiCvAnalysisPrompt" className="block text-sm font-semibold text-gray-900">
                  AI CV Analysis Prompt
                </label>
              ...
              <div className="relative">
                <textarea
                  ...
                  onChange={(e) => onInputChange("aiCvAnalysisPrompt", e.target.value)}
              ...
              <p className="text-xs text-gray-600 mt-2">
                This prompt guides how AI evaluates and scores candidate CVs before proceeding to interviews.
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <label htmlFor="aiFirstInterviewPrompt" className="block text-sm font-semibold text-gray-900">
                  AI First Interview Questions Prompt
                </label>
              ...
              <div className="relative">
                <textarea
                  ...
                  onChange={(e) => onInputChange("aiFirstInterviewPrompt", e.target.value)}
                  className="w-full px-4 py-4 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none transition-all duration-200 placeholder-gray-500 text-gray-900"
              ...
              <p className="text-xs text-gray-600 mt-2">
                First interview focuses on basic qualifications and cultural fit assessment.
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <label htmlFor="aiSecondInterviewPrompt" className="block text-sm font-semibold text-gray-900">
                  AI Second Interview Questions Prompt
                </label>
              ...
              <div className="relative">
                <textarea
                  ...
                  onChange={(e) => onInputChange("aiSecondInterviewPrompt", e.target.value)}
                  className="w-full px-4 py-4 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none transition-all duration-200 placeholder-gray-500 text-gray-900"
              ...
              <p className="text-xs text-gray-600 mt-2">
                Second interview dives deeper into technical skills and advanced competencies.
              </p>
            </div>
          </div>
          
          {/* Regenerate Button */}
          {(jobData.aiCvAnalysisPrompt || jobData.aiFirstInterviewPrompt || jobData.aiSecondInterviewPrompt) && onRegeneratePrompts && (
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <p className="text-gray-600 text-sm mb-4">
            Leave fields empty to use our intelligent default prompts, or customize them based on your specific role requirements.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="group bg-white border border-gray-200 rounded-xl p-4 hover:border-primary-400 hover:shadow-md transition-all duration-200 cursor-pointer">
              <div className="flex items-center gap-2 mb-2">
                <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
                <h4 className="font-semibold text-gray-900 text-sm">Technical Roles</h4>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">Focus on coding skills, technical problem-solving, system design, and software development expertise</p>
            </div>
            <div className="group bg-white border border-gray-200 rounded-xl p-4 hover:border-primary-400 hover:shadow-md transition-all duration-200 cursor-pointer">
              <div className="flex items-center gap-2 mb-2">
                <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="font-semibold text-gray-900 text-sm">Management Roles</h4>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">Emphasize leadership capabilities, team management, strategic thinking, and organizational skills</p>
            </div>
            <div className="group bg-white border border-gray-200 rounded-xl p-4 hover:border-primary-400 hover:shadow-md transition-all duration-200 cursor-pointer">
              <div className="flex items-center gap-2 mb-2">
                <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="font-semibold text-gray-900 text-sm">Creative Roles</h4>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">Evaluate portfolio quality, creative thinking, design skills, and artistic problem-solving abilities</p>
            </div>
          </div>
        </div>
      </div>
