...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (props, ref) => {
    const {
      ...
      disabled,
      onClick,
      ripple, // destructure ripple so it is not spread to DOM
      ...rest
    } = props;
    ...
    const variantClasses = {
      primary:
        "bg-gradient-to-r from-[#13ead9] to-[#0891b2] hover:from-[#0891b2] hover:to-[#13ead9] text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 hover:scale-[1.01] focus:ring-[#0891b2]/40 focus:ring-offset-white",
      secondary:
        "bg-gradient-to-r from-gray-50 to-white text-gray-700 border border-gray-300 shadow-sm hover:shadow-md hover:scale-[1.01] hover:text-[#0891b2] hover:border-[#0891b2]/30 focus:ring-gray-400/40",
      outline:
        "border-2 border-[#0891b2] text-[#0891b2] bg-transparent hover:bg-gradient-to-r hover:from-[#13ead9]/5 hover:to-[#0891b2]/5 hover:scale-[1.01] hover:shadow-sm focus:ring-[#0891b2]/40",
      ghost:
        "text-[#0891b2] bg-transparent hover:bg-gradient-to-r hover:from-[#13ead9]/10 hover:to-[#0891b2]/10 hover:scale-[1.01] focus:ring-[#0891b2]/40",
      glass:
        "bg-white/80 backdrop-blur-lg text-gray-800 border border-gray-200/50 shadow-lg hover:shadow-xl hover:bg-white/90 hover:border-[#0891b2]/30 hover:scale-[1.01] hover:text-[#0891b2] focus:ring-gray-400/40",
      "hero-primary":
        "bg-gradient-to-r from-[#13ead9] to-[#0891b2] text-white font-bold shadow-xl hover:shadow-2xl transform hover:-translate-y-1 hover:scale-[1.02] focus:ring-[#0891b2]/40 focus:ring-offset-white",
      "hero-secondary":
        "bg-white/90 backdrop-blur-lg text-gray-800 font-semibold border border-gray-200/50 shadow-lg hover:shadow-xl hover:bg-white hover:border-[#0891b2]/30 hover:scale-[1.02] hover:text-[#0891b2] focus:ring-gray-400/40",
      danger:
        "bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 hover:scale-[1.01] focus:ring-red-500/40",
      success:
    ...
    const ButtonContent = () => {
      ...
      return (
        <>
          {ripple && <RippleEffect />}
          {(variant === "primary" || variant === "hero-primary") && (
            <GradientOverlay />
          )}
