...
const featuredCompanies = [
  {
    ...
    openJobs: 6,
    description: "Leading telecommunications company providing innovative mobile and digital services.",
    slug: "zain",
    featured: true,
    color: "purple"
  },
  ...
  },
  {
    ...
    location: "Doha, Qatar",
    openJobs: 8,
    description: "World-class airline connecting the globe with cutting-edge technology.",
    slug: "qatar-airways",
    featured: true,
    color: "red"
  },
  {
    ...
    openJobs: 15,
    description: "Building the future of smart cities with cutting-edge technology.",
    slug: "neom",
    featured: true,
    color: "green"
  },
  ...
  },
  {
    ...
    location: "Dubai, UAE",
    openJobs: 4,
    description: "Protecting Dubai with cutting-edge technology and innovation.",
    slug: "dubai-police",
    featured: false,
    color: "indigo"
  }
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xl font-bold text-gray-900">{company.openJobs}</div>
                </div>
              </div>
              ...
              <Button 
                variant="primary" 
                href={company.slug === "zain" ? `/corporate/${company.slug}` : "#"} 
                className="w-full"
              >
                View Jobs
              </Button>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Discover opportunities across {allCompanies.length} leading organizations
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {allCompanies.map((company) => (
              ...
              >
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-gray-900">{company.openJobs} jobs</div>
