...
const jobsData: JobData[] = [
  {
    ...
    applicants: 23,
    logo: "🏢",
    description: "Join Saudi Arabia's leading tech transformation initiative building next-generation digital solutions. You'll work on cutting-edge projects that impact millions of users across the Kingdom, using modern technologies and best practices in software development.",
    urgent: true
  },
  {
    id: 2,
    ...
    applicants: 41,
    logo: "✈️",
    description: "Drive digital product innovation for Qatar's world-class airline and travel ecosystem. Lead cross-functional teams to deliver exceptional customer experiences across all touchpoints."
  },
  {
    id: 3,
    title: "UX Designer",
    ...
    applicants: 18,
    logo: "📱",
    description: "Design innovative digital experiences for Jordan's leading telecommunications company. Focus on creating intuitive, accessible interfaces that serve diverse user needs across the region."
  },
  {
    id: 4,
    ...
    applicants: 35,
    logo: "🌟",
    description: "Shape the future of smart cities with cutting-edge AI and data science at NEOM. Work on revolutionary projects that will define the next generation of urban living and sustainability.",
    urgent: true
  },
  {
    id: 5,
    ...
    applicants: 29,
    logo: "🚗",
    description: "Lead regional marketing campaigns for the Middle East's super app serving millions. Drive user acquisition and engagement across multiple markets and platforms."
  },
  {
    id: 6,
    ...
    applicants: 27,
    logo: "☁️",
    description: "Architect next-generation cloud and 5G solutions for Qatar's digital transformation. Design scalable, secure infrastructure that supports the country's vision for digital innovation."
  },
  {
    id: 7,
    ...
    applicants: 15,
    logo: "🛡️",
    description: "Protect Dubai's digital infrastructure with cutting-edge cybersecurity solutions. Join a team dedicated to maintaining the highest security standards for one of the world's smartest cities."
  },
  {
    id: 8,
    ...
    applicants: 31,
    logo: "🧠",
    description: "Advance AI research at one of the world's leading science and technology universities. Collaborate with international researchers on groundbreaking projects that push the boundaries of artificial intelligence."
  }
];
                  ...
                  <div className="flex items-center gap-4 text-gray-600 mb-4">
                    <div className="flex items-center gap-1">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-2M5 21h2m0 0h2" />
                      </svg>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                {jobsData.filter(j => j.id !== jobId).slice(0, 3).map((similarJob: JobData) => (
                  <div key={similarJob.id} className="border border-gray-100 rounded-lg p-3 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center text-sm border border-gray-200">
                        {similarJob.logo}
                      </div>
                      <div className="flex-1 min-w-0">
                        <h4 className="font-medium text-gray-900 text-sm truncate">{similarJob.title}</h4>
                        <p className="text-xs text-gray-500 truncate">{similarJob.company}</p>
