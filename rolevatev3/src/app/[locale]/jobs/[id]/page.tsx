...
const jobs = [
  {
    ...
    description:
      "We are looking for a Senior Frontend Developer to join our dynamic team and help build cutting-edge web applications. You will work on challenging projects using modern technologies and collaborate with a talented team of developers.",
    descriptionAr:
      "نبحث عن مطور واجهة أمامية أول للانضمام إلى فريقنا الديناميكي ومساعدتنا في بناء تطبيقات الويب المتطورة. ستعمل على مشاريع مثيرة باستخدام التقنيات الحديثة وتتعاون مع فريق موهوب من المطورين.",
    requirements: [
    ...
    companyDescription:
      "TechCorp Solutions is a leading technology company specializing in web and mobile application development. We work with clients across various industries to deliver innovative digital solutions.",
    companyDescriptionAr:
      "تك كورب سوليوشنز هي شركة تقنية رائدة متخصصة في تطوير تطبيقات الويب والموبايل. نحن نعمل مع عملاء في مختلف الصناعات لتقديم حلول رقمية مبتكرة.",
  },
  {
    id: 2,
    ...
    description:
      "Join our creative team as a UX/UI Designer and help shape the future of digital experiences. You will work on diverse projects for clients across different industries.",
    descriptionAr:
      "انضم إلى فريقنا الإبداعي كمصمم تجربة مستخدم وواجهة ومساعدتنا في تشكيل مستقبل التجارب الرقمية. ستعمل على مشاريع متنوعة لعملاء في مختلف الصناعات.",
    requirements: [
    ...
    companyDescription:
      "Design Studio is a full-service design agency that creates exceptional digital experiences for brands worldwide. We combine creativity with strategic thinking to deliver outstanding results.",
    companyDescriptionAr:
      "استوديو التصميم هو وكالة تصميم شاملة تخلق تجارب رقمية استثنائية للعلامات التجارية حول العالم. نحن نجمع بين الإبداع والتفكير الاستراتيجي لتقديم نتائج متميزة.",
  },
  {
    id: 3,
    ...
    description:
      "We are seeking a talented Backend Developer to build scalable web applications. You will work on our core platform and help us scale to serve millions of users.",
    descriptionAr:
      "نبحث عن مطور خلفية موهوب لبناء تطبيقات الويب القابلة للتوسع. ستعمل على منصتنا الأساسية وتساعدنا في التوسع لخدمة ملايين المستخدمين.",
    requirements: [
    ...
    companyDescription:
      "StartupXYZ is a fast-growing technology startup revolutionizing the way people connect and collaborate online. We are backed by top-tier investors and are on a mission to build the future of digital collaboration.",
    companyDescriptionAr:
      "ستارت أب XYZ هي شركة تقنية ناشئة سريعة النمو تغير طريقة اتصال وتعاون الناس عبر الإنترنت. نحن مدعومون من قبل مستثمرين من الدرجة الأولى ونحن في مهمة لبناء مستقبل التعاون الرقمي.",
  },
];
...
export default async function JobDetailPage({
  ...
  const { code, q, location, jobType, salary, experience, company } =
    await searchParams;
