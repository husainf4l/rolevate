              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-center py-4 px-4 font-semibold">{plans[0].name}</th>
                    <th className="text-center py-4 px-4 font-semibold">{plans[1].name}</th>
                    <th className="text-center py-4 px-4 font-semibold">{plans[2].name}</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <CardContent className="p-8 lg:p-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold mb-2">{t('aiFeatures.intelligent.title')}</h3>
                  <p className="text-sm text-muted-foreground">{t('aiFeatures.intelligent.description')}</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold mb-2">{t('aiFeatures.automated.title')}</h3>
                  <p className="text-sm text-muted-foreground">{t('aiFeatures.automated.description')}</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold mb-2">{t('aiFeatures.accurate.title')}</h3>
                  <p className="text-sm text-muted-foreground">{t('aiFeatures.accurate.description')}</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold mb-2">{t('aiFeatures.scalable.title')}</h3>
                  <p className="text-sm text-muted-foreground">{t('aiFeatures.scalable.description')}</p>
                </div>
              </div>
            </CardContent>
          </Card>
