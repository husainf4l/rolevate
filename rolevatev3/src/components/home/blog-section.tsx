    ...
    const fetchBlogs = async () => {
      try {
        ...
        if (moreBlogsResponse.success && moreBlogsResponse.blogs) {
          ...
          const nonFeaturedBlogs = moreBlogsResponse.blogs.filter(
            blog => !blog.featured
          ).slice(0, 4);
      ...
      <div className="container mx-auto px-4">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400 mb-4">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>{blog.readingTime} {locale === 'ar' ? 'دقيقة' : 'min read'}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="sm" asChild className="group-hover:text-primary">
                    <Link href={`/${locale}/blog/${blog.slug}` as any}>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <Button variant="outline" asChild>
                <Link href="/blog">
                  ...
                  <ChevronRight className={`w-4 h-4 ml-2 ${locale === 'ar' ? 'rotate-180' : ''}`} />
                </Link>
              </Button>
            </div>
        ...
        <div className="text-center">
          <Button size="lg" asChild>
            <Link href="/blog">
              {locale === 'ar' ? 'استكشف جميع المقالات' : 'Explore All Articles'}
              <ArrowRight className={`w-5 h-5 ml-2 ${locale === 'ar' ? 'rotate-180' : ''}`} />
            </Link>
          </Button>
        </div>
      </div>
