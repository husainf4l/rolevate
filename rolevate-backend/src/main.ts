  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: ["'self'", 'data:', 'https:', 'http://localhost:3005', 'http://localhost:4005'],
        connectSrc: ["'self'", 'http://localhost:3005', 'http://localhost:4005', 'wss://rolvate2-ckmk80qb.livekit.cloud', 'https://rolvate2-ckmk80qb.livekit.cloud'],
      },
    },
