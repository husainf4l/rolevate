      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between py-6 px-6 lg:px-12">
        ...
        <div className="flex-1 flex items-center justify-center order-1 lg:order-2 mb-8 lg:mb-0 lg:ml-12">
          <div className="relative w-96 h-80 lg:w-[36rem] lg:h-[28rem]">
            <div className="absolute inset-0 bg-white/10 rounded-sm shadow-corporate backdrop-blur-sm border border-white/20"></div>
            ...
            <div className="absolute -top-4 -right-4 w-8 h-8 bg-[#13ead9] rounded-full shadow-corporate"></div>
            <div className="absolute -bottom-6 -left-6 w-6 h-6 bg-[#0891b2] rounded-full shadow-corporate"></div>
          </div>
        </div>
