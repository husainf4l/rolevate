  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="text-center py-8">
        ...
        <p className="text-lg text-gray-600 mt-2">Track and manage candidates through your AI-powered hiring process</p>
      </div>
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-center">
                            <div className="flex items-center justify-center gap-2">
                              <Link
                                href={`/business/candidates/${candidate.id}`}                                className="text-[#0891b2] hover:text-[#0fc4b5] font-medium text-sm"
                              >
                                View
                              </Link>
                              <button
